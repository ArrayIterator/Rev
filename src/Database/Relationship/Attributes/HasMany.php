...
use ArrayIterator\Rev\Source\Database\Relationship\HasMany as HasManyRelation;
use ArrayIterator\Rev\Source\Database\Relationship\RelationshipInterface;
use Attribute;

#[Attribute(Attribute::TARGET_CLASS|Attribute::IS_REPEATABLE)]
class HasMany implements RelationshipAttributeInterface
{
    ...
    {
        return new HasManyRelation($entity, $this);
    }
}
