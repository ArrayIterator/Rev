...
namespace ArrayIterator\Rev\Source\Http\Traits;

use ArrayIterator\Rev\Source\Http\Exceptions\MalformedHeaderException;
use ArrayIterator\Rev\Source\Http\Exceptions\MalformedMethodException;
use InvalidArgumentException;
use Psr\Http\Message\UriInterface;

trait HttpAssertionTrait
{
    protected function assertUri(mixed $uri)
    {
     ...
     * @param mixed $header
     */
    protected function assertHeaderName(mixed $header)
    {
        if (!is_string($header)) {
            throw new MalformedHeaderException(
                sprintf(
     ...
     * @param mixed $method
     */
    protected function assertMethod(mixed $method)
    {
